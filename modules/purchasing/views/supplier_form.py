...
class SupplierFormPage(QWidget):
    ...
    def _create_commercial_tab(self) -> QWidget:
        ...
        self.credit_limit_input = CurrencyInput()
    ...
    def load_data(self):
        ...
        self.contact_person_input.setText(
            self.supplier_data.get("contact_person", "") or ""
        )
        ...
        self.country_input.setText(
            self.supplier_data.get("country", "Türkiye") or "Türkiye"
        )

        # Ticari
        self.payment_term_input.setValue(
            self.supplier_data.get("payment_term_days", 30) or 30
        )
        self.credit_limit_input.setValue(
            float(self.supplier_data.get("credit_limit", 0) or 0)
        )
        ...
        self.bank_account_input.setText(
            self.supplier_data.get("bank_account_no", "") or ""
        )
