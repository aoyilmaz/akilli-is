...
class WarehouseModule(QWidget):
    ...
    def setup_ui(self):
        ...
        self.list_page.header.search_changed.connect(lambda _: self.load_data())
    ...
    def load_data(self):
        try:
            ...
            warehouses = self.warehouse_service.get_all(active_only=False)
            ...
            if search:
                ...
                warehouses = [
                    w
                    for w in warehouses
                    if search_lower in w.code.lower() or search_lower in w.name.lower()
                ]
