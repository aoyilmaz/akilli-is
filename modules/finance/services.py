...
class AccountTransactionService:
    ...
    def get_customer_statement(
        ...
        return query.order_by(AccountTransaction.transaction_date, AccountTransaction.id).all()
...
class ReconciliationService:
    ...
    def get_reconciliation_report(
        ...
        if customer_id:
            ...
            entity = self.session.query(Customer).filter(Customer.id == customer_id).first()
        elif supplier_id:
            ...
            entity = self.session.query(Supplier).filter(Supplier.id == supplier_id).first()
        else:
            raise ValueError("Müşteri veya tedarikçi belirtilmeli")
