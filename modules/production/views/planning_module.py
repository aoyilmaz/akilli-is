        ...
        try:
            ...
            for ws in stations:
                work_stations.append({
                    ...
                    "code": ws.code,
                    "name": ws.name,
                    "station_type": ws.station_type.value if ws.station_type else "machine",
                ...
                if wo.operations:
                    for op in wo.operations:
                        ...
                        if not op.planned_start and not op.planned_end:
                            ...
                            if total_ops > 0:
                                total_duration = (wo.planned_end - wo.planned_start).total_seconds()
                        ...
                        if op.status == "completed":
                            ...
                            if op.completed_quantity and wo.planned_quantity:
                                progress = float(op.completed_quantity / wo.planned_quantity * 100)
