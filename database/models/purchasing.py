...
class PurchaseRequestItem(BaseModel):
    ...
    item_id = Column(Integer, ForeignKey("items.id"), nullable=True)  # items tablosuna referans
...
class PurchaseOrderItem(BaseModel):
    ...
    def remaining_quantity(self) -> Decimal:
        return Decimal(str(self.quantity or 0)) - Decimal(str(self.received_quantity or 0))
