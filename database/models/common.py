...
class Currency(BaseModel):
    ...
    def format_amount(self, amount: Decimal) -> str:
        ...
        formatted = (
            ...
            .replace("X", self.thousand_separator)
        )
...
class City(Base):
    ...
    # Index
    __table_args__ = (Index("idx_city_country", "country_id"),)
...
class District(Base):
    ...
    # Index
    __table_args__ = (Index("idx_district_city", "city_id"),)
...
class LabelTemplate(BaseModel):
    ...
    template_type = Column(String(50), nullable=False)  # product, work_order

    # Şablon içeriği (Jinja2 formatında HTML)
    content = Column(Text, nullable=False)

    # Boyutlar (mm)
    width_mm = Column(Integer, default=100)
    height_mm = Column(Integer, default=50)
