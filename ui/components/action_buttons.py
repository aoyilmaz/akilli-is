...
İşlem butonları için yardımcı fonksiyonlar - Phosphor Icons ve Modern UI
"""
...
def create_view_button(parent=None) -> QPushButton:
    ...
    _apply_action_style(btn, "text_secondary", "Görüntüle", ICONS.EYE)
    return btn
